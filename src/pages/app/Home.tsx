  ...
  return (
    <div className="px-5 pt-2 pb-4 space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="relative w-11 h-11 rounded-2xl bg-card shadow-card grid place-items-center" aria-label="Notifikasi">
        ...
        <div className="grid grid-cols-2 gap-3">
          {quickActions.map((a) => (
            <Link
              key={a.title}
              to={a.to}
              className="p-3 rounded-2xl bg-card shadow-card flex items-center gap-3 hover:-translate-y-0.5 transition-smooth"
            >
              <div className={`w-10 h-10 rounded-xl grid place-items-center ${a.bg}`}>
      ...
      <div>
        ...
        <div className="rounded-2xl bg-card shadow-card p-3 flex items-center gap-3">
          ...
          <img src={article1} alt="Artikel kehamilan" loading="lazy" className="w-20 h-20 rounded-xl object-contain bg-secondary/30" />
        </div>
      </div>
    </div>
  );
